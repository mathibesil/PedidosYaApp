package com.prueba.besil.pedidosyaprueba.di.module
...
import com.prueba.besil.pedidosyaprueba.data.network.util.AddAuthInterceptor
import com.prueba.besil.pedidosyaprueba.data.network.util.ConnectivityInterceptor
import com.prueba.besil.pedidosyaprueba.data.preferences.AppPreferenceHelper
import com.prueba.besil.pedidosyaprueba.data.preferences.PreferenceHelper
import com.prueba.besil.pedidosyaprueba.di.BaseUrl
import com.prueba.besil.pedidosyaprueba.di.PreferenceInfo
import com.prueba.besil.pedidosyaprueba.ui.home.view.MainAdapterRestaurante
...
class AppModule {
    ...
    @Provides
    @Singleton
    internal fun provideMainAdapterRestaurante(): MainAdapterRestaurante = MainAdapterRestaurante(ArrayList())
